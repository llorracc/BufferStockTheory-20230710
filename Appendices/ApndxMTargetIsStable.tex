...
Since by assumption $ 0 < \underline{\PermShk} \leq \PermShk_{t+1} \leq \bar{\PermShk} < \infty$, our proof in~\ref{subsubsec:RatExitsCont} that demonstrated existence and continuity of $\Ex_{t}[\mNrm_{t+1}/\mNrm_{t}]$ implies existence and continuity of $\Ex_{t}[\PermShk_{t+1}\mNrm_{t+1}/\mNrm_{t}]$.

\subsubsection{Existence of a stable point}

Since by assumption $ 0 < \underline{\PermShk} \leq \PermShk_{t+1} \leq \bar{\PermShk} < \infty$, our proof in Subsection~\ref{subsubsec:RatExitsCont} that the ratio of $\Ex_{t}[\mNrm_{t+1}]$ to $\mNrm_{t}$ is unbounded as $\mNrm_{t} \downarrow 0$ implies that the ratio $\Ex_{t}[\PermShk_{t+1}\mNrm_{t+1}]$ to $\mNrm_{t}$ is unbounded as $\mNrm_{t} \downarrow 0$.
